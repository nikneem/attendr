...
output storageAccountName string = resourceDeployment.outputs.storageAccountName
output postgresServerName string = resourceDeployment.outputs.postgresServerName
