...
This directory contains the Infrastructure as Code (IaC) for deploying the Presence service to Azure Container Apps.
...
- Resource Group for Presence service
- Container App with:
  - System-assigned managed identity
  - Dapr integration (app ID: `presence-api`)
