# Groups Service Infrastructure

This directory contains the Infrastructure as Code (IaC) for deploying the Groups service to Azure Container Apps.
...
- Resource Group for Groups service
- Container App with:
  - System-assigned managed identity
  - Dapr integration (app ID: `groups-api`)
